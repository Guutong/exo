...
) -> Tuple[List[Callable[[mx.array], mx.array]], Optional[List[Any]]]:
    """
    Build the same filter chain as ``make_sampler``, but expose it directly
    (Guutong/mlx-lm MTP fork; used by ``mtp_generate_step`` in generate.py).
    """
